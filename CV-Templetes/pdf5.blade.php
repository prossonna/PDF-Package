    ...
    <table role="presentation" border="0" width="100%" cellpadding="0" cellspacing="0" style=" padding: 10px 20px 10px;">
        ...
        <tr>
            <td>
                <table role="presentation" border="0" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="70%" valign="top" style="padding: 0 20px 0 0;">
        ...
        <tr>
            <td colspan="2">
                <a href="#" style="text-decoration: none;"><p style="margin: 5 0; text-transform: capitalize;">https://github.com/prossonna</p></a>
                <a href="#" style="text-decoration: none;"><p style="margin: 5 0; text-transform: capitalize;">https://github.com/prossonna</p></a>
            </td>
        </tr>
        <tr>
